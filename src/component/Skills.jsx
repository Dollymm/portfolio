...
<Card sx={{width:'300px', height:'15rem', display:'flex',justifyContent:'center', color:'#a0a0b5', background:'none',boxShadow:'rgba(23,92,230,0.15) 0px 4px 24px',px:'6px',border: "rgb(53, 53, 53) 0.1rem solid",borderRadius:'15px',mb:'20px'}}>
<Box >
<Typography sx={{fontSize:'20px', fontWeight:'600', display:'flex',justifyContent:'center',mb:'5px'}}>Frontend</Typography>
   ...
   
{
  Frontend.map(data=>(
    ...
    <Grid item xs={6}>
    <Box sx={{display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'row', border:'1px solid #91a1d1',borderRadius:'12px',gap:'6px'}}>
      <img src={data.image} style={{ height: '1.5rem' }}/>
      <Typography sx={{p:'1px'}}> {data.name}</Typography>
    </Box>
    </Grid>
  ))
}
