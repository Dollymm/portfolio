...
const Projects=({project})=> {
  return (
    <Container ref={project}>
            ...
            <Typography marginTop={10}  color={'#a0a0b5'} textAlign={'center'}  fontSize={20} fontWeight={600}>Browse My Recent</Typography>
           
         <Name marginTop={2} marginBottom={4}  color={'#a0a0b5'} fontSize={50} fontWeight={700}>Projects</Name>
        <Contain>
            {
